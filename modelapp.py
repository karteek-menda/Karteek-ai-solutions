...
st.beta_set_page_config(page_title = 'Real Estate Predictor', page_icon ='🏠')
...
def set_png_as_page_bg(png_file):
    ...
    return
set_png_as_page_bg('Real-Estate.jpg')
...
html_temp = """
    ...
    <h2 style="color:yellow;text-align:center;">Real Estate Predictions</h2>
    </div>
    """
